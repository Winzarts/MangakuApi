...
def popular_komik():
    ...
    return jsonify(_parse_popular_items(BeautifulSoup(html, "html.parser")))


@popular_bp.route('/popular-manga', methods=['GET'])
def popular_manga():
...
@popular_bp.route("/popular-manhwa", methods=["GET"])
def popular_manhwa():
...
@popular_bp.route("/popular-manhua", methods=["GET"])
def popular_manhua():
